package kr.co.happycoding.mybrowser.adapter
...
import kr.co.happycoding.mybrowser.activity.MainActivity

class BookmarkAdapter(
    private val context: Context,
    private val isActivity: Boolean = false): RecyclerView.Adapter<BookmarkAdapter.MyHolder>() {
